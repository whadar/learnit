...
export const SURFACE_FX = {
  ...
  dirt_track: { sprite: 'dust', a: C(0xf1e3c6), b: C(0x7a6038), rate: 88, size: [0.8, 4.2], rise: 0.85, drag: 1.05, chips: 0.5, decal: 'scuff', decalAlpha: 0.30, wet: 0 },
  dirt: { sprite: 'dust', a: C(0xefdfbe), b: C(0x6b5230), rate: 96, size: [0.85, 4.6], rise: 0.9, drag: 1.0, chips: 0.6, decal: 'scuff', decalAlpha: 0.30, wet: 0 },
  unpaved: { sprite: 'dust', a: C(0xf1e3c6), b: C(0x7a6038), rate: 90, size: [0.8, 4.4], rise: 0.88, drag: 1.05, chips: 0.55, decal: 'scuff', decalAlpha: 0.30, wet: 0 },
  ...
  orchard: { sprite: 'dust', a: PALETTE.soil, b: PALETTE.soilDark, rate: 84, size: [0.75, 3.8], rise: 0.85, drag: 1.15, chips: 0.7, decal: 'scuff', decalAlpha: 0.26, wet: 0, mud: 0.8 },
  soil: { sprite: 'dust', a: PALETTE.soil, b: PALETTE.soilDark, rate: 92, size: [0.8, 4.2], rise: 0.9, drag: 1.05, chips: 0.8, decal: 'scuff', decalAlpha: 0.3, wet: 0, mud: 0.8 },
  farmyard: { sprite: 'dust', a: C(0xf1e3c6), b: C(0x6b5230), rate: 86, size: [0.78, 4.0], rise: 0.85, drag: 1.1, chips: 0.7, decal: 'scuff', decalAlpha: 0.28, wet: 0, mud: 0.8 },
  sand: { sprite: 'dust', a: C(0xf6ead0), b: C(0x8c6f42), rate: 110, size: [0.9, 5.0], rise: 0.95, drag: 0.95, chips: 0.4, decal: 'scuff', decalAlpha: 0.24, wet: 0 },
