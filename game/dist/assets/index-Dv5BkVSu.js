...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function cs(e,t,n){let r=new Float32Array(Jo),i=new J(0,1,0);return new Na({name:`SphericalGaussianBlur`,defines:{n:Jo,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ds(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ls(){return new Na({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ds(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function us(){return new Na({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ds(),fragmentShader:`
	...
	`}var fs=class extends Vt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ni(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};function iu(e,t,n={}){let r=new ru;r.scale.setScalar(2e4),e.scene.add(r);let i=r.material.uniforms;i.turbidity.value=4.5,i.rayleigh.value=1.6,i.mieCoefficient.value=.004,i.mieDirectionalG.value=.82;let a=n.elevation??34,o=n.azimuth??122,s=xt.degToRad(90-a),c=xt.degToRad(o),l=new J().setFromSphericalCoords(1,s,c);i.sunPosition.value.copy(l);let u=new ho(16773852,3.4);u.position.copy(l).multiplyScalar(1200),u.castShadow=!0,u.shadow.mapSize.set(2048,2048);let d=u.shadow.camera;d.left=-300,d.right=300,d.top=300,d.bottom=-300,d.near=1,d.far=3e3,e.scene.add(u),e.scene.add(u.target);let f=new $a(12375807,11573869,.75);return e.scene.add(f),{sky:r,sun:u,hemi:f,sunPos:l}}var au=new Zl(document.getElementById(`app`)),ou=window.__game={engine:au,world:null,ready:!1,error:null,views:{},setView(e){let t=this.views[e];if(!t)throw Error(`unknown view: `+e);au.camera.position.set(...t.pos),au.camera.lookAt(new J(...t.look)),au.camera.fov=t.fov??62,au.camera.updateProjectionMatrix()},renderOnce(){au.render()}};(async()=>{try{let e=ou.world=await eu.load();iu(au,e),tu(au,e),nu(au,e);let t=(t,n)=>e.heightAt(t,n);ou.views={overview:{pos:[-620,t(-620,620)+320,620],look:[0,t(0,0),0],fov:55},village:{pos:[120,t(120,180)+45,180],look:[-40,t(-40,20)+6,20],fov:50},street:{pos:[-20,t(-20,40)+3.2,40],look:[60,t(60,10)+2,10],fov:65},ridge:{pos:[500,t(500,-500)+90,-500],look:[0,t(0,0),0],fov:48}},ou.setView(`overview`),au.start(),ou.ready=!0}catch(e){ou.error=String(e&&e.stack||e),console.error(e)}})();