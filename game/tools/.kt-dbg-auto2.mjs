...
console.log(await page.evaluate(() => {
  ...
  // also count how many meshes actually get drawn into the shadow map
  return 'auto on; extent-ish far=' + L.sun.shadow.camera.far;
}));
await settle(10);
await page.screenshot({ path: OUT+'dbg_auto2.png', timeout: 300000 });
await browser.close();
